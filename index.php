          ...
          <form class="needs-validation" novalidate action="efetuar-pagamento.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <select class="custom-select d-block w-100" name="bandeira" id="bandeira" required>
                  <option value="">Choose...</option>
                  <option>Visa</option>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="cc-number" id="cc-number" placeholder="" onkeypress="mascaraCard(this)" maxlength="19" required>
                <div class="invalid-feedback">
